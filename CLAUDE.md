...
### 3.5 No Threadfin / xTeVe — DECIDED

Both Plex and Jellyfin ingest M3U + XMLTV directly. Threadfin only earns its
keep filtering thousand-channel IPTV lists. Do not reintroduce it.
